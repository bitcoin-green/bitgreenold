...
The following applies to code changes to the BitGreen Core project, and is not to be
confused with overall BitGreen Network Protocol consensus changes.

Whether a pull request is merged into BitGreen Core rests with the project merge
...
Patches that change BitGreen consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitGreen consensus, it must have been
...
The project leader is the release manager for each BitGreen Core release.
