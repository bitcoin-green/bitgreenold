...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitGreen Core bitgreen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitgreen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitgreen transaction") + "\n" +
                               "  bitgreen-tx [options] -create [commands]   " + _("Create hex-encoded bitgreen transaction") + "\n" +
                               "\n";
