...
Intro
-----
BitGreen (BITG) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. BitGreen utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run bitgreen-qt.exe.

BitGreen Core is the original BitGreen client and it builds the backbone of the network.
However, it downloads and stores the entire history of BitGreen transactions;
