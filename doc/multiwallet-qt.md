...
In order to support loading of multiple wallets in bitgreen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitgreen.cpp.
...
Changes to bitgreen.cpp
----------------------
bitgreen.cpp is the entry point into bitgreen-qt, and as such, will require some minor modifications to provide hooks for
