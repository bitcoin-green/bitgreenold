...
In order to support loading of multiple wallets in bitcoingreen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoingreen.cpp.
...
Changes to bitcoingreen.cpp
----------------------
bitcoingreen.cpp is the entry point into bitcoingreen-qt, and as such, will require some minor modifications to provide hooks for
