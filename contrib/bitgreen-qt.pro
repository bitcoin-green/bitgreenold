...
RESOURCES += src/qt/bitgreen.qrc src/qt/bitgreen_locale.qrc

TRANSLATIONS += src/qt/locale/bitgreen_bg.ts \
                src/qt/locale/bitgreen_de.ts \
                src/qt/locale/bitgreen_en.ts \
                src/qt/locale/bitgreen_es.ts \
                src/qt/locale/bitgreen_fi.ts \
                src/qt/locale/bitgreen_fr.ts \
                src/qt/locale/bitgreen_it.ts \
                src/qt/locale/bitgreen_ja.ts \
                src/qt/locale/bitgreen_pl.ts \
                src/qt/locale/bitgreen_pt.ts \
                src/qt/locale/bitgreen_ru.ts \
                src/qt/locale/bitgreen_sk.ts \
                src/qt/locale/bitgreen_sv.ts \
                src/qt/locale/bitgreen_vi.ts \
                src/qt/locale/bitgreen_zh_CN.ts \
                src/qt/locale/bitgreen_zh_TW.ts
